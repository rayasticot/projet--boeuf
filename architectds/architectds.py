...
BLOCKSDS = os.environ.get('BLOCKSDS', '/opt/wonderful/thirdparty/blocksds/core')
BLOCKSDSEXT = os.environ.get('BLOCKSDSEXT', '/opt/wonderful/thirdparty/blocksds/external')
